...
RGB16 with Rec.2020/PQ by default, optional Display P3/PQ, or Rec.2020/HLG.
...
RGB16 PQ or HLG for edit/master use. PQ supports Rec.2020 and Display P3; HLG
is Rec.2020. Native structured color encoding is used. Lossless mode is
...
10-bit 4:4:4 Rec.2020/PQ or Rec.2020/HLG using AV1. PQ is the default. This is
a compact lossy HDR output whose application support is less universal than
its container and color signaling suggest.
